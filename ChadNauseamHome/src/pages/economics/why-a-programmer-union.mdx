...
Things like better programming languages and tooling help everyone. But they're _non-rivalrous_ and<Note numbered>due to the programmer preference for open-source</Note> relatively _non-excludable_. These combine to make programmer tooling a _public good_. (i.e. a good that is consumed by the public).
