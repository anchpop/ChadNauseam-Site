...
I actually have a fun design for a positive feedback loop that would lead to wide adoption of the union, once we get it started! Here's how it works:
...
The idea is that this creates a feedback loop - the more companies join the union, the more money goes to UGPL projects. The more money goes to UGPL projects, the more UGPL projects there are. The more UGPL projects there are, the greater the incentive is to join the union.
