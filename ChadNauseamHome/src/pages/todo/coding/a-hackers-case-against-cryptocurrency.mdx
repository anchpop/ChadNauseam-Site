...
There's also [Ceramic](https://ceramic.network/), which seems to do the same thing. Data is stored on IPFS. They do the annoying thing where they advertise a lot of cool features on their website, and then when you go to use them you find out they're not implemented yet (sadly common in the blockchain space). But they seem to have the right ideas in general, and I think something interesting might come of it.

## Mobile and browser

I respect Metamask and related projects for being a huge improvement over what came before. 
These are browser extensions that hold your keys, and when you want to interact with the chain, you get a little popup saying "do you want to sign this message?" or "do you want to approve this operation?" and if you click "confirm" it goes through.

But most people don't have Metamask, and if you want to support this same workflow on an iOS or Android app, as far as I can tell you're just totally screwed. 
